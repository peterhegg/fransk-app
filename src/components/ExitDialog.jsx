...
export default function ExitDialog({ phraseIdx, onStay, onExit }) {
  ...
  return (
    <div role="alertdialog" aria-modal="true" aria-label="Avslutte øvelsen?" style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.65)", zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ background: "var(--surface-solid)", border: "1px solid var(--border)", borderRadius: 20, padding: "32px 28px", maxWidth: 320, width: "100%", textAlign: "center", boxShadow: "var(--shadow-md)" }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center" }}>
          <button ref={stayRef} onClick={onStay} className="btn-shine"
