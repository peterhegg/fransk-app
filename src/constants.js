...
export const GRAMMAR_TOPICS = [
  ...
  },
  {
    ...
    pairs: [
      ...
      { fr: "le matin", no: "morgenen", phonetic: "lə matæn" },
      { fr: "la soirée", no: "kvelden", phonetic: "la swaræ" },
      ...
      { fr: "le temps", no: "tiden / været", phonetic: "lə tå" },
      { fr: "la vie", no: "livet", phonetic: "la vi" },
    ],
  },
  {
    id: "negation",
    ...
    pairs: [
      ...
      { fr: "je ne comprends rien", no: "jeg forstår ingenting", phonetic: "sjø nə kåprå rjæn" },
  ...
  },
  {
    ...
    pairs: [
      ...
      { fr: "j'ai fait mes devoirs", no: "jeg gjorde leksene mine", phonetic: "sjæ fæ mæ dəvwar" },
      { fr: "je suis allé(e) à Paris", no: "jeg dro til Paris", phonetic: "sjø swi zalæ a pari" },
      { fr: "elle est arrivée en retard", no: "hun kom for sent", phonetic: "æl æt arivæ å rətar" },
      { fr: "nous sommes partis tôt", no: "vi dro tidlig", phonetic: "nu sOm parti to" },
      { fr: "tu es rentré(e) à la maison", no: "du kom hjem", phonetic: "ty æ råntræ a la mæzån" },
      { fr: "ils sont venus hier", no: "de kom i går", phonetic: "il sån vøny jær" },
      { fr: "elle s'est levée à six heures", no: "hun stod opp klokken seks (refleksivt med être)", phonetic: "æl sæ læ væ a si zœr" },
    ],
  },
  ...
  },
  {
    ...
    pairs: [
      ...
      { fr: "nos enfants", no: "barna våre", phonetic: "no zånfå" },
      ...
      { fr: "leurs enfants", no: "barna deres", phonetic: "lœr zånfå" },
    ],
  },
  {
    id: "futur-proche",
  ...
  },
  {
    ...
    pairs: [
      ...
      { fr: "une belle femme", no: "en vakker kvinne (beau → belle i hunkjønn)", phonetic: "yn bæl fam" },
      ...
      { fr: "une vieille maison", no: "et gammelt hus (vieux → vieille i hunkjønn)", phonetic: "yn vjæj mæzån" },
      { fr: "un nouveau film", no: "en ny film (hankjønn)", phonetic: "øn nuvo film" },
      { fr: "une nouvelle idée", no: "en ny idé (nouveau → nouvelle i hunkjønn)", phonetic: "yn nuvæl idæ" },
      { fr: "un beau tableau", no: "et vakkert maleri", phonetic: "øn bo tablo" },
      { fr: "une bonne idée", no: "en god idé (bon → bonne)", phonetic: "yn bOn idæ" },
    ],
  },
  {
